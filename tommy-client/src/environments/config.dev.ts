...
export const config = {
    ...
    // GET_PLACES: () => `/api/caisd-rest/loc?WC=z_moked`,///////TODO:  z_moked not empty,
    GET_PLACES: () => `/api/caisd-rest/loc?WC=z_moked%20LIKE%20'25'`,///////TRY: z_moked equal nothing,
    ...
    GET_ORGANIZATION: (userT: string) => `/api/caisd-rest/cnt?WC=organization%3D'${userT}'`,
    GET_PLACE: (userT: string) => `/api/caisd-rest/loc?WC=organization%3D'${userT}'`,
