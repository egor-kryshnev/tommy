export const config = {
    ...
    GET_CLOSED_TASKS_URL_FUNCTION: (UUID: string) => `/api/caisd-rest/cr?WC=customer%3DU${UUID}%20and%20type%3D'R'%20and%20active%3D0`,
    ...
    GET_UPDATES: "/api/caisd-rest/cr?WC=type%3D'I'%20and%20active%3D1%20and%20impact%3D0",
