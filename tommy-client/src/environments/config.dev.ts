export const config = {
    ...
    GET_OPEN_TASKS_URL_FUNCTION: (UUID: string) => `http://localhost/api/lehava-api-mock:8050/caisd-rest/cr?WC=customer%3DU'${UUID}'%20and%20type%3D'R'%20and%20active%3D1`,
