export const config = {
    ...
    GET_OPEN_TASKS_URL_FUNCTION: (id: string) => `http://localhost/api/lehava-api-mock:8050/caisd-rest/cr?WC=customer%3D${id}%20and%20type%3D'R'%20and%20active%3D1`,
    GET_CLOSED_TASKS_URL_FUNCTION: (id: string) => `http://localhost/api/lehava-api-mock:8050/caisd-rest/cr?WC=customer%3D${id}%20and%20type%3D'R'%20and%20active%3D0`,
