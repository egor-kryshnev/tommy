...
export class SupportersListService {
    ...
    private static supportersList: Supporter[];

    public static async getSupportersList(accessToken: number): Promise<Supporter[]> {
        if (!SupportersListService.supportersList || !await this.isValidExpirationDate()) {
            ...
            if (redisSupportersList && this.isValidExpirationDate) {
                ...
                await this.setRedis('Supporters-List', supportersListRes.toString());
                ...
                SupportersListService.supportersList = supportersListRes;
            }
        }
